import { HTMLMotionProps, invariant, m } from "framer-motion";
import { FunctionComponent, ReactHTML, forwardRef, useEffect, useRef } from "react";
import { ItemData, ReorderContextProps } from "./types";
import { checkReorder } from "./utils";
import { useConstant } from "@/hooks/useConstant";
import { ReorderContext } from "./ReorderContext";
...
export function ReorderGroup<V>(
	{
		...
		values,
		...props
	}: Props<V> & Omit<HTMLMotionProps<any>, "values"> & React.PropsWithChildren<{}>,
	externalRef?: React.Ref<any>
) {
	const Component = useConstant(() => m(as)) as FunctionComponent<
